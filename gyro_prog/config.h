...
#define DMP_SAMPLE_RATE    70 // Logging/DMP sample rate(4-200 Hz)
#define IMU_COMPASS_SAMPLE_RATE 70 // Compass sample rate (4-100 Hz)
#define IMU_AG_SAMPLE_RATE 70 // Accel/gyro sample rate Must be between 4Hz and 1kHz
